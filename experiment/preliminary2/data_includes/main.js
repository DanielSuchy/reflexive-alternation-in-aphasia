...
newTrial("practice1",                //v těchle dvou trialech je nácvik.
    ...
    newHtml("<hr>")
        .print()
    ,
    newImage("positive", "positive.png")
        .size(125,150)
    ,
    newImage("negative", "negative.png")
        .size(125,150)
    ,
    newCanvas(450, 100)
        .add(0,0, getImage("positive"))
        .add(150,0,getImage("negative"))
        .print()
    ,
    newSelector()
        .add(getImage("positive"), getImage("negative"))
        .keys("A", "N")
        .log()
        .once()
        .wait()
...
Template("stimuli.csv", variable =>                             //vlastní experiment je vytvořený tak, že je tady šablona (template), ve které je popsaný průběh jedné položky. jednotlivé položky se pak berou z tabulky "stimuli.csv", která je ve složce resources
  newTrial("experiment",
    ...
    newCanvas(450, 100)
        ...
        .print()
    ,
    newSelector("sentence-judgement-selector")
        .add(getImage("positive"), getImage("negative"))
        .keys("A", "N")
        .log()
        .once()
	...
	.log("ArgumentVariation", variable.ArgumentVariation)     //obsahuje správnou odpověď na otázku
	.log("Transitive", variable.Transitive)     //obsahuje správnou odpověď na otázku
	.log("Grammatical", variable.Grammatical)     //obsahuje správnou odpověď na otázku
 )
